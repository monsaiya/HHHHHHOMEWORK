    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCalculate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String result = String.format("ค่า BMI ที่ได้  %.1f",Bmi);
                String result2 = String.format("อยู่ในเกณฑ์ : %s",BmiText );
...
//                );
//                dialog.show();
                Intent h = new Intent(BMI.this,BmiResult.class);
                h.putExtra("q",result);
                h.putExtra("p",result2);
                startActivity(h);
            }
        });
